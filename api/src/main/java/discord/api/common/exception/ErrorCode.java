...
public enum ErrorCode {
    ...
    FRIENDSHIP_REQUEST_NOT_FOUND(HttpStatus.BAD_REQUEST, "4008", "FRIENDSHIP REQUEST NOT FOUND"),
    ...
    // 404 Not Found
    EMAIL_NOT_FOUND(HttpStatus.NOT_FOUND, "4041", "EMAIL NOT FOUND"),
    USER_NOT_FOUND(HttpStatus.NOT_FOUND, "4042", "USER NOT FOUND"),
    PASSWORD_INVALID(HttpStatus.NOT_FOUND, "4043", "PASSWORD INVALID"),
    ...
    AWS_S3_UPLOAD_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "5004", "AWS S3 UPLOAD FAIL"),
    AWS_S3_DOWNLOAD_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "5005", "AWS S3 DOWNLOAD FAIL"),
    FILE_PROCESSING_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "5006", "FILE PROCESSING FAIL");
